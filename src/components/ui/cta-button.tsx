...
export function CtaButton({
  ...
  const solid =
    "bg-[var(--color-surface-black)] text-[var(--color-ink-on-black)] shadow-[0_1px_0_rgba(255,255,255,0.08)_inset,0_0_0_0_rgba(255,68,0,0)] hover:shadow-[0_0_0_1px_var(--color-accent),0_14px_32px_-10px_rgba(255,68,0,0.5)] hover:text-white";
